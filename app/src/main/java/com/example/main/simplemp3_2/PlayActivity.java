...
public class PlayActivity extends AppCompatActivity {
    ...
    private TextView txvSongTitle, txvSongArtist, txvPlayingTime, txvSongDuration;
    ...
    BroadcastReceiver UIbroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            txvSongDuration.setText(String.format("%2d:%02d", song.getDuration() / 60000, song.getDuration() / 1000 % 60));
    ...
    private Runnable mp3StartRunable = new Runnable() {
        ...
        public void run() {
            ...
            txvPlayingTime.setText(String.format("%2d:%02d", musicController.getSongPlayingPos() / 60000, musicController.getSongPlayingPos() / 1000 % 60));
    ...
    private SeekBar.OnSeekBarChangeListener seekBarChangeListener = new SeekBar.OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
            txvPlayingTime.setText(String.format("%2d:%02d", seekBar.getProgress() / 60000, seekBar.getProgress() / 1000 % 60));
        }
    ...
    private void updateRepeatImgButtonView() {
        if (repeatMode.equals(REPEAT)) {
            btnRepeatMode.setImageResource(R.drawable.btn_repeat_all);
        }else if (repeatMode.equals(REPEATONE)) {
            btnRepeatMode.setImageResource(R.drawable.btn_repeat_one);
        }else if (repeatMode.equals(SHUFFLE)) {
            btnRepeatMode.setImageResource(R.drawable.btn_repeat_shffle);
        }
    }
